...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_RX_STACK_SIZE, 3092);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_GATT_CLIENT, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_PB_GATT_CLIENT, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_PRIV_BEACON_CLI, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_LPN_SCAN_LATENCY, 15);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_SHELL_PRIV_BEACON_CLI, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_MAX_CONN, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_TICKER_EXT_SLOT_WINDOW_YIELD, 1);
